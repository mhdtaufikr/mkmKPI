          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Master Checksheet Model</h3>
              </div>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="modal-add-label">Add Master Checksheet Model</h5>
                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <form action="{{ url('/mst/model/store') }}" method="POST">
                                  @csrf
                                    ...
                                    <script>
                                        ...
                                        $(document).ready(function() {
                                            ...
                                            $('#add-input').click(function() {
                                                $('#input-container').append('<div class="input-group mt-2 mb-2"><input type="text" class="form-control" name="model[]" placeholder="Enter Item Checksheet" required><button type="button" class="btn btn-secondary remove-input">-</button></div>');
                                            });
                    ...
                    <div class="modal fade" id="modal-update{{ $data->id }}" tabindex="-1" aria-labelledby="modal-update{{ $data->id }}-label" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <form action="{{ url('/mst/model/update') }}" method="POST">
                              @csrf
                              @method('patch')
                              <div class="modal-body">
                                  ...
                                  <div class="form-group mb-3">
                                    <select name="shop_id" id="shop_id" class="form-control">
                                        <option value="{{ $data->shop_id }}">{{ $data->section->shop_name}}</option>
                                        @foreach ($shopName as $shop)
                                             <option value="{{$shop->id }}">{{ $shop->shop_name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                <input value="{{$data->model_name}}" type="text" class="form-control" name="shop" placeholder="Enter Item Checksheet" required>
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-dark" data-bs-dismiss="modal">Close</button>
